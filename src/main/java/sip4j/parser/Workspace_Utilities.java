...
public class Workspace_Utilities {
	...
	public static List<ICompilationUnit> collectCompilationUnits(IJavaElement javaElement) {
		...
		if (javaElement instanceof IParent) {
			...
			try {
				...
				log.log(Level.SEVERE, "Problem traversing Java model element: "
						+ parent, jme);
			}
		} else {
	 ...
	 * @throws Exception
	 */
	public static Map<ICompilationUnit, ASTNode> parseCompilationUnits(
	...
	public static List<MethodDeclaration> scanForMethodDeclarations(
		...
		for (; compUnitIterator.hasNext();) {
			...
			tempMethodList = scanForMethodDeclarationsFromAST(compilationUnitToASTNode
					.get(icu));
	 ...
	 * @throws Exception
	 */
	public static List<MethodDeclaration> scanForMethodDeclarationsFromAST(
	 ...
	 */
	public static ASTNode getASTNodeFromCompilationUnit(
